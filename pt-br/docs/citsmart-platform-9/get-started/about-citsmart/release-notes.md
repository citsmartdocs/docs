...
## Versão 9.1.2.33 (2021/09/30)

Bem-vindos ao CITSmart Versão 9.1.2.33. Esta versão apresenta as seguintes correções:

|Número |Tipo |Descrição|
|-------|--------|---------|	
|12660  |Correção|  Remoção do código Heart Beat do sistema |
