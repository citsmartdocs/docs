...
3.  Na área intitulada "Execução", clicar no ícone "Adicionar nota" e preencher
    ...
    !!! Abstract "ATENÇÃO"
        ...
        No histórico fica registrado todas as ações realizadas desde a criação até o encerramento, servindo como Auditoria. O registro de ocorrências referentes ao ticket é realizado através do
