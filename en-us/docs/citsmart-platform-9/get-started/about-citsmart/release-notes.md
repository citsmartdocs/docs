...
## Version 9.1.2.29 (2021/04/14)

Welcome to CITSmart Version 9.1.2.29. This version presents the following corrections:
...
## Version 9.1.2.28 (2021/03/24)

Welcome to CITSmart Version 9.1.2.28. This version presents the following improvements:
...
## Version 9.1.2.27 (2021/03/23)

Welcome to CITSmart Version 9.1.2.27. This version presents the following improvements:
...
Welcome to CITSmart Version 9.1.2.26. This version presents the following improvements:
...
!!! warning "ATTENTION"
    ...
    Before downloading this version, check the guidelines in the document [CITSmart 9 Guide version 1.2.13][2]

Welcome to CITSmart 9 Version 1.2.13. This version features the following items:
...
|10012|Corrective|Ticket Mgmt.|Correction in the rendering of Neuro forms|
...
|10023|Corrective|Webservice|Correction of the mechanism for websocket telephony with Neuro|
...
|10098|Corrective|Ticket Mgmt.|Treat null pointer in the OcorrenciaSolicitacaoNeuro class|
...
## Version 9.1 (2020/09/14)
Welcome to CITSmart Version 9.1. This version presents the following items:
...
|4875|Corrective|Simple|Adjusted in the view of an expired sprint|
...
Welcome to Neuro 1.3.5.0. The version presented has the following correction(s):

|Number|Type|Description|
|--------|---------|---------|
|7814|Corrective|Refactory of integration with ITSM to allow the flexibility of the external URL of the Neuro|
...
|7774|Improvement|Translation error in NEURO --> ESI|


## Version 9.0 (2020/07/10)
Welcome to Citsmart Version 9.0. This version presents the following items:

|Number|Type|Functionality|Description|
|--------|---------|---------|---------|
|8968|Corrective|Experience Center|Correction in the return of the list of Portfolios when parameter 293 that filters the portfolio by access groups is enabled|
